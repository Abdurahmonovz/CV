          ...
          <div className="cv-body">
            <div className="sidebar">
              ...
              <div className="s-section">
                ...
                <div className="prog-bar-row">
                  <div className="prog-name"><span>React</span><span>78%</span></div>
                  <div className="prog-track"><div className="prog-fill" style={{ width: "78%" }}></div></div>
                </div>
                <div className="prog-bar-row">
                ...
                <div className="prog-bar-row">
                  <div className="prog-name"><span>Next.js</span><span>65%</span></div>
